...
public class OracleDB extends BaseDB {
	...
	private static final String[] _ORACLE = {
		"--", "1", "0", "to_date('1970-01-01 00:00:00','YYYY-MM-DD HH24:MI:SS')",
		"sysdate", " blob", " blob", " number(30, 16)", " number(1, 0)",
		" timestamp", " number(30,20)", " number(30,0)", " number(30,0)",
		" clob", " clob", " varchar2(4000 char)", "", "commit"
	};

	private static final int[] _SQL_TYPES = {
		Types.BLOB, Types.BLOB, Types.NUMERIC, Types.NUMERIC, Types.TIMESTAMP,
		Types.NUMERIC, Types.NUMERIC, Types.NUMERIC, Types.CLOB, Types.CLOB,
	...
	public boolean isUseUnicodeSupport(Connection connection) {
		return true; // Oracle maneja Unicode internamente
	}
}